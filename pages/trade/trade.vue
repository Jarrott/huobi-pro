<template>
	<view>
		<uni-nav-bar left-icon="arrow-left" backgroundColor="#0c1723" color="#fff">
			<view>
				{{symbol.toUpperCase()}}
			</view>
		</uni-nav-bar>
			...
			<view>
				<view class="flex">
					<view class="field">
						...
						<view class="value">{{detail.high.toFixed(8)}}</view>
					</view>
					<view class="field">
				...
				<view class="flex">
					<view class="field">
						...
						<view class="value">{{detail.low.toFixed(8)}}</view>
					</view>
					<view class="field">
